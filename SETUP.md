...
You'll notice that "foooothm-bot" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "foooothm-bot" and its variances with your own
project's name.
...
```
foooothm-bot other-config.yaml
```
